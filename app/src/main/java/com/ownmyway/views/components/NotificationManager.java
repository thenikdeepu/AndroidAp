...
import static com.ownmyway.App.DRIVER_CHANNEL_ID;
import static com.ownmyway.App.RIDER_CHANNEL_ID;
...
public class NotificationManager {
    ...
    public NotificationManager(Activity activity, Class referenceClass) {
